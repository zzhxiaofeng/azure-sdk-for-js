...
export interface BatchAccount extends Resource {
  ...
  /**
   * The dedicated core quota for this Batch account. **NOTE: This property will not be serialized.
   * It can only be populated by the server.**
   */
  readonly dedicatedCoreQuota?: number;
  /**
   * The low-priority core quota for this Batch account. **NOTE: This property will not be
   * serialized. It can only be populated by the server.**
   */
  readonly lowPriorityCoreQuota?: number;
  /**
   * The pool quota for this Batch account. **NOTE: This property will not be serialized. It can
   * only be populated by the server.**
   */
  readonly poolQuota?: number;
  /**
   * The active job and job schedule quota for this Batch account. **NOTE: This property will not
...
export interface CloudServiceConfiguration {
   ...
   * equivalent to Windows Server 2016. For more information, see Azure Guest OS Releases
...
export interface Pool extends ProxyResource {
   ...
   * application packages affect all new compute nodes joining the pool, but do not affect compute
