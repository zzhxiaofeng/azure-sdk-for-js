...
#### nodejs - Authentication, client creation and list managedApis as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.managedApis.list(location).then((result) => {
...
#### browser - Authentication, client creation and list managedApis as an example written in JavaScript.
